"""
    Old module, that works with pretrained
GPT-model.
"""

import datetime
import torch
# Вместо модулей из трансформера использовать модули от Вани
...
class ChatBot:
    ...
    def get_reply(self, user_message):
        ...
        if self.chat_history_ids is not None:
            message_ids = torch.cat(
                [self.chat_history_ids, message_ids], dim=-1)
